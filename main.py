...
El NEV (Net Emotional Value) mide las emociones 
positivas y negativas para entender que es lo 
que impulsa la acción de preferencia en una 
relación de corto y largo plazo, ya que algunas emociones generan respuestas a corto y otras a largo. 

La fórmula del NEV es: 
nev = total de emociones positivas - total de emociones negativas 

Digamos que hicimos los cálculos de 
todas las emociones ingresadas por 
el usuario—por referencia ver principal.py—y 
obtenemos un total de 18 emociones positivas 
contra 7 emociones negativas: 
""" 
...
""" 
Informarte si las proporciones nutricionales 
que tuviste en el día es lo ideal:
Digamos que calculamos por una serie de 
procesos complejos utilizando la teoría del curso,
las kilocalorías que el usuario idealmente debería
consumir en un día, eso es, digamos, 2200 
kilocalorías.
""" 
...
proteinas_g = (calorias_ideales_al_dia * porcentaje_proteinas) / 4 

#1 gramo de carbohidrato = 4 kilocalorías 
carbohidratos_g = (calorias_ideales_al_dia * porcentaje_carbohidratos) / 4 

#1 gramo de grasa = 9 kilocalorías 
grasas_g = (calorias_ideales_al_dia *porcentaje_grasas) / 9 
...
#Ambición final: Al final me gustaría correlacionar con el coeficiente 
de correlación los cuatro cálculos de cada ejemplo de arriba mostrado 
y crear una gráfica en el archivo de texto o generar una imagen 
que muestre lo dicho. 
